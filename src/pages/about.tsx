  ...
  >
    ...
    <div style={{ position: 'relative', flex: 1, color: COLOR, padding: '40px 16px 24px' }}>
      <div style={{ maxWidth: 820, margin: '0 auto' }}>
        ...
        <hr style={{ width: '70%', margin: '0 auto 20px', border: 0, borderTop: `1px solid ${COLOR}`, opacity: 0.5 }} />
        ...
        <p style={{ fontSize: 'small', lineHeight: 1.5 }}>
          ...
          development of this product through grant numbers 2054079 and 2131097. Any opinions, findings, and conclusions
    ...
    <div
      style={{ position: 'relative', textAlign: 'center', color: COLOR, fontSize: 'smaller', padding: '8px 16px 16px' }}
    >
