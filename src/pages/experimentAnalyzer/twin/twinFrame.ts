 ...
 * model, spliced in from twinFrameApi.ts (which also runs it in Node, for its tests and the photo-set eval,
 * §32). After a program has run, what it left floating is set down onto what is under it and the roofs
